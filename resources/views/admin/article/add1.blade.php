...
{{--                    {{ csrf_field() }}--}}
                ...
                <div class="layui-input-block">
                    <input style="width: 40%;" type="text" id="username" name="art_title" required="" lay-verify="required"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input style="width: 20%;"  type="text" id="username" name="art_editor" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
...
{{--                <div class="layui-input-block">--}}
{{--                    <textarea style="width: 40%;" name="desc" name="art_description" class="layui-textarea"></textarea>--}}
{{--                </div>--}}
{{--            </div>--}}
            ...
            <div class="layui-form-item" style="margin-top: 20px;">
                ...
                <div class="layui-input-block">
                    <input style="width: 40%;" type="text" id="username" value="肯天智能专注智慧酒店20年，自主研发并融合国内外先进技术，拥有独立知识产权国内领先的智慧酒店系统全套解决方案，迄今已合作海内外酒店企业上万家。" name="web_description" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item" style="margin-top: 20px;">
                ...
                <div class="layui-input-block">
                    <input style="width: 40%;" type="text" id="username" value="智慧酒店,智慧酒店方案,智慧酒店解决方案,肯天智能" name="web_keywords" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    ...
                    <input  type="checkbox" name="status" lay-skin="switch" lay-filter="switchTest" lay-text="推荐|普通">
                </div>
            </div>
