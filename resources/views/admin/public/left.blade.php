        ...
        <ul id="nav">
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li>
                        <a onclick="xadmin.add_tab('权限列表','{{url('admin/per')}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>权限列表</cite></a>
                    </li>
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('菜单列表','{{url('admin/category')}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>菜单列表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="幻灯片管理">&#xe6a8;</i>
                    <cite>幻灯片管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('幻灯片列表','{{url('admin/banner')}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>幻灯片列表</cite></a>
                    </li>
                </ul>
            ...
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="新闻文章">&#xe6fb;</i>
                    <cite>新闻文章管理</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('新闻列表','{{url('admin/art')}}')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>新闻文章列表</cite></a>
                    </li>
                </ul>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('添加新闻','{{url('admin/art/create')}}')">
                            <i class="iconfont">&#xe69e;</i>
                            <cite>添加新闻文章</cite></a>
                    </li>
                </ul>
